...
//@UtilityClass
public class JsonBodyFactoryForAllegroRequest {

    public static JSONObject createPublishOfferBodyWithGTIN(PublishOfferDto publishOfferDto) {
    ...
    public static JSONObject createPublishOfferBodyWithSpecificId(PublishOfferDto publishOfferDto) {
